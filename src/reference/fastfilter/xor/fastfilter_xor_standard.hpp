...
namespace filters {
    ...
    struct Filter<FilterType::FastfilterXor, fastfilter::_xor::Standard<k>, k, OP> {
        ...
        using F = xorfilter::XorFilter<T, FP, H>;
        ...
        bool contains(const T &value, const size_t = 0) {
            return xorfilter::Status::Ok == filter->Contain(value);
        }
        ...
        std::string to_string() {
            ...
            s += "\t\"filter_params\": " + fastfilter::_xor::Standard<k>::to_string() + ",\n";
